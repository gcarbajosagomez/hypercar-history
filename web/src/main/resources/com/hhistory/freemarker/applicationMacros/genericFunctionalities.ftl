...
<#macro endPage chunkedModelsList=[]>
					...
					<div class="hypercar-history-footer navbar">
                        ...
                        <div class="row">
							...
							<h5 class="text-muted nano-address <#if requestIsDesktop>text-center<#else>text-left</#if>"><img class="nano-logo" src="/static/img/crypto/nano-logo.jpg" title="${language.getTextSource('footer.donations.donate')} ${language.getTextSource('nano')}" alt="${language.getTextSource('footer.donations.donate')} ${language.getTextSource('nano')}"> : ${language.getTextSource('footer.donations.nano.address')}</h5>
