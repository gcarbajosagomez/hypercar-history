                        ...
                        <div class="row technology-stack-inner-logo">
                            ...
                            <div class="thumbnail row technology-stack-inner-logo">
                                <div class="col-lg-6" style="padding-top:30px;">
                                    <img class="center-block" src="/static/img/tech-stack/spring-framework-logo.png" alt="Spring Framework loog">
                                </div>
                                <div class="col-lg-6">
                                    <img class="center-block" src="/static/img/tech-stack/java8-logo.png" alt="Java 8 logo">
                                </div>
                            </div>
                        </div>
                    </div>
